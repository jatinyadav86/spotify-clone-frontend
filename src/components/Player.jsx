...
export const Player = () => {
    ...
    return (
        ...
        <div ref={playerRef} className='fixed z-40 top-0 hidden'>
            <div style={{ backgroundColor: songPlaying.song?.color }} className="h-screen w-screen relative">
                <div className="w-full h-full absolute top-0 right-0  bg-gradient-to-b from-transparent to-[#121212c2]"></div>
                <div className="h-screen w-screen  text-white p-3 flex flex-col justify-between absolute top-0 right-0">
                    ...
                    <div className="w-full h-[70%] flex justify-center items-center">
                        <img className='h-[70%]' src={songPlaying.song?.image} alt="" />
                    </div>
                    <div className="w-full h-14 flex justify-between items-center px-4 my-4">
                        ...
                        {liked.filter(value => value.songName == songPlaying.song?.songName).length > 0 ?
                            ...
                            :
                            <img onClick={() => addLikedSong(songPlaying.song)} className='size-8' src="https://res.cloudinary.com/doswveiik/image/upload/v1726669454/heart_ue1t0a.png" alt="" />
                        }
                    </div>
                    <div className="w-full seekbar flex flex-col items-center my-6 gap-2">
                        <div className="w-[93%] lg:w-[437px] relative flex items-center group">
                    ...
                    <div className="w-full flex items-center justify-between px-4 mt-5">
                        <img className='size-8' src="https://res.cloudinary.com/doswveiik/image/upload/v1726671398/connect_sdvgs5.svg" alt="" />
                        <img className='size-7' src="https://res.cloudinary.com/doswveiik/image/upload/v1726671471/share_ojb1ke.svg" alt="" />
                    </div>
                </div>
            </div>
        </div>
